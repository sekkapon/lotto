                            ...
                            <tbody align="center">
                                ...
                                foreach ($datapayrate as $k => $val) {
                                    ...
                                    <tr id="changColor">
                                        ...
                                        <td id="v_3upper_<?= $val['user_id']; ?>"><?= $val['detail']['t_3upper']['payRate']; ?></td>
                                        <td id="v_3under_<?= $val['user_id']; ?>"><?= $val['detail']['t_3under']['payRate']; ?></td>
                                        <td id="v_3toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_3toad']['payRate']; ?></td>
                                        <td id="v_2upper_<?= $val['user_id']; ?>"><?= $val['detail']['t_2upper']['payRate']; ?></td>
                                        <td id="v_2under_<?= $val['user_id']; ?>"><?= $val['detail']['t_2under']['payRate']; ?></td>
                                        <td id="v_2toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_2toad']['payRate']; ?></td>
                                        <td id="v_floatUpper_<?= $val['user_id']; ?>"><?= $val['detail']['t_floatUpper']['payRate']; ?></td>
                                        <td id="v_floatUnder_<?= $val['user_id']; ?>"><?= $val['detail']['t_floatUnder']['payRate']; ?></td>
