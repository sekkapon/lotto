    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Setting Bet Per Number</h3>
                <p class="text-subtitle text-muted">ตั้งค่าตั้งอั้น</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Table Bet Per Number</h4>
                    <small>ตารางตั้งค่าตั้งอั้น</small>
                </div>
                            ...
                            <tbody align="center">
                                ...
                                foreach ($dataperbet as $k => $val) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="v_3upper_<?= $val['user_id']; ?>"><?= $val['detail']['t_3upper']['maxCostPerNumber']; ?></td>
                                        <td id="v_3under_<?= $val['user_id']; ?>"><?= $val['detail']['t_3under']['maxCostPerNumber']; ?></td>
                                        <td id="v_3toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_3toad']['maxCostPerNumber']; ?></td>
                                        <td id="v_2upper_<?= $val['user_id']; ?>"><?= $val['detail']['t_2upper']['maxCostPerNumber']; ?></td>
                                        <td id="v_2under_<?= $val['user_id']; ?>"><?= $val['detail']['t_2under']['maxCostPerNumber']; ?></td>
                                        <td id="v_2toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_2toad']['maxCostPerNumber']; ?></td>
                                        <td id="v_floatUpper_<?= $val['user_id']; ?>"><?= $val['detail']['t_floatUpper']['maxCostPerNumber']; ?></td>
                                        <td id="v_floatUnder_<?= $val['user_id']; ?>"><?= $val['detail']['t_floatUnder']['maxCostPerNumber']; ?></td>
                                        <td id="v_4toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_4toad']['maxCostPerNumber']; ?></td>
                                        <td id="v_5toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_5toad']['maxCostPerNumber']; ?></td>
