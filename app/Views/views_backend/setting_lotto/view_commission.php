                            ...
                            <tbody align="center">
                                ...
                                foreach ($datacommision as $k => $val) {
                                    ...
                                    <tr>
                                        ...
                                        <td id="v_3upper_<?= $val['user_id']; ?>"><?= $val['detail']['t_3upper']['percent']; ?></td>
                                        <td id="v_3under_<?= $val['user_id']; ?>"><?= $val['detail']['t_3under']['percent']; ?></td>
                                        <td id="v_3toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_3toad']['percent']; ?></td>
                                        <td id="v_2upper_<?= $val['user_id']; ?>"><?= $val['detail']['t_2upper']['percent']; ?></td>
                                        <td id="v_2under_<?= $val['user_id']; ?>"><?= $val['detail']['t_2under']['percent']; ?></td>
                                        <td id="v_2toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_2toad']['percent']; ?></td>
                                        <td id="v_floatUpper_<?= $val['user_id']; ?>"><?= $val['detail']['t_floatUpper']['percent']; ?></td>
                                        <td id="v_floatUnder_<?= $val['user_id']; ?>"><?= $val['detail']['t_floatUnder']['percent']; ?></td>
                                        <td id="v_4toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_4toad']['percent']; ?></td>
                                        <td id="v_5toad_<?= $val['user_id']; ?>"><?= $val['detail']['t_5toad']['percent']; ?></td>
